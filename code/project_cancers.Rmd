...
```{r}
df_slope1 <- as.data.frame(matrix(0, 6, 4))
colnames(df_slope1) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope2 <- as.data.frame(matrix(0, 5, 4))
colnames(df_slope2) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope3 <- as.data.frame(matrix(0, 4, 4))
colnames(df_slope3) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope4 <- as.data.frame(matrix(0, 3, 4))
colnames(df_slope4) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope5 <- as.data.frame(matrix(0, 5, 4))
colnames(df_slope5) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope6 <- as.data.frame(matrix(0, 4, 4))
colnames(df_slope6) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope7 <- as.data.frame(matrix(0, 4, 4))
colnames(df_slope7) <- c("cancer", "survival1", "survival2", "survival3")
...
df_slope8 <- as.data.frame(matrix(0, 4, 4))
colnames(df_slope8) <- c("cancer", "survival1", "survival2", "survival3")
...
ggplot(df_slope1) + 
  ...
  ggtitle("Overall Survival of Caucasian Women, 50-54 from Different Cancers")+
  ...
  guides(color = guide_legend(order = 1, nrow = 2), linetype = guide_legend(order = 2, nrow = 2))
...
ggplot(df_slope2) + 
  ...
  ggtitle("Overall Survival of Caucasian Men, 50-54 from Different Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
 theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope3) + 
  ...
  ggtitle("Overall Survival of Hispanic Women, 50-54 from Different Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
 theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope4) + 
  ...
  ggtitle("Overall Survival of Hispanic Men, 50-54 from Different Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
  theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope5) + 
  ...
  ggtitle("Overall Survival of African American Women, 50-54 from\nDifferent Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
  theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope6) + 
  ...
  ggtitle("Overall Survival of African American Men, 50-54 from\nDifferent Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
  theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope7) + 
  ...
  ggtitle("Overall Survival of Asian or Pacific Islander Women, 50-54 from\nDifferent Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
  theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
ggplot(df_slope8) + 
  ...
  ggtitle("Overall Survival of Asian or Pacific Islander Men, 50-54 from \nDifferent Cancers")+
  scale_linetype_manual(name = "Effectiveness", values = lines)+
  theme_classic()+ 
  theme(panel.background = element_blank(), 
        panel.grid = element_blank(),
...
plot_data_pancreas75 <- plot_data_pancreas75 %>% filter(age %in% c("00 years", "01-04 years", "05-09 years", "10-14 years", "15-19 years", "20-24 years") == FALSE)
...
ggplot()+
  ...
  theme_light()+
  theme(title = element_text(size = 32),
        axis.text.x = element_text(vjust = 0.5, hjust=1, size = 28),
...
#have to do mesothelioma slightly different since it has a missing panel
